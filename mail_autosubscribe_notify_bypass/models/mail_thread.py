...
class MailThread(models.AbstractModel):
    ...
    def _check_autosubscribe_bypass(self):
        ...
        return self._name in company.autosubscribe_bypass_model_ids.mapped(
            "model") or company.autosubscribe_bypass_all
    ...
    def _message_auto_subscribe_notify(self, partner_ids, template):
        if self._check_autosubscribe_bypass():
            ...
            partners = self.env["res.partner"].browse(partner_ids).mapped(
                "name")
            msg = (
