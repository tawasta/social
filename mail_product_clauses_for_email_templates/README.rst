...
* Create the clauses via Settings -> Technical -> E-mail Product Clauses (sales manager rights required):
  ...
  * Type in the clause contents and translate them as necessary.
  * Finally, set the clauses' preferred order in the treeview with the sequence handle

Usage
=====
* In your Sale Order or Invoice email template of choice, apply <t t-out="object.email_product_clause_contents"/>
...
======================
* Implement variable support (so that you can get e.g. access SO field contents from clauses)
